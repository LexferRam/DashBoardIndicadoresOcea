  ...
  useEffect(() => {
    ...
    if (valor === "Recaudo de Divisas en Efectivo") {
      ...
      for (let i = 0; i < enviardataGraph.length; i += 1) {
        chartData.push([enviardataGraph[i].OFICINA, enviardataGraph[i].MTO_MONEDA, 'fill-color:#47c0b6;stroke-color: blue;stroke-width: 1',  enviardataGraph[i].MTO_MONEDA])
      }
      setJson(chartData);
      ...
      for (let i = 0; i < enviardataGraph.length; i += 1) {
        chartData.push([enviardataGraph[i].OFICINA, enviardataGraph[i].MTO_SOBRANTE, 'fill-color:#47c0b6;stroke-color: blue;stroke-width: 1 ', enviardataGraph[i].MTO_SOBRANTE])
      }
      setJson(chartData);
      setTitle(valor)
    }
      ...
      for (let i = 0; i < enviardataGraph.length; i += 1) {
        chartData.push([enviardataGraph[i].OFICINA, enviardataGraph[i].MTO_FALTANTE, 'fill-color:#47c0b6;stroke-color: blue;stroke-width: 1 ', enviardataGraph[i].MTO_FALTANTE])
      }
      setJson(chartData);
    }
